...
pub const individual_modifiers = [_]GalleryExample{
    ...
    GalleryExample.init("Tilt Shift", "Advanced miniature depth of field effect", &[_][]const u8{ "tilt-shift", "3.0", "0.6", "0.2" }),
...
pub const combinations = [_]GalleryExample{
    ...
    GalleryExample.init("Miniature Model", "Enhanced tilt-shift with vibrant colors for realistic toy effect", &[_][]const u8{ "tilt-shift", "4.0", "0.65", "0.15", "vibrance", "0.6", "contrast", "1.1" }),
    GalleryExample.init("Macro Photography", "Strong tilt-shift with narrow focus for close-up effect", &[_][]const u8{ "tilt-shift", "5.5", "0.4", "0.08", "saturation", "1.2" }),
