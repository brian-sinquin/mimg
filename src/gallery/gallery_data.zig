...
pub const individual_modifiers = [_]GalleryExample{
    ...
    GalleryExample.init("Hue Shift", "Shift hue by 60 degrees", &[_][]const u8{ "hue-shift", "60" }),
...
pub const combinations = [_]GalleryExample{
    ...
    GalleryExample.init("Gaussian Blur + Emboss", "Soft emboss effect", &[_][]const u8{ "gaussian-blur", "1.5", "emboss" }),
    GalleryExample.init("Vignette + Posterize", "Vintage poster effect", &[_][]const u8{ "vignette", "0.3", "posterize", "16" }),
    GalleryExample.init("Hue Shift + Saturation", "Color transformation", &[_][]const u8{ "hue-shift", "120", "saturation", "1.2" }),
};
